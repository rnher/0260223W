                                                        ...
                                                        <div class="wrap-productshot__boxbc d-flex flex-column p-relative">
                                                            ...
                                                            <div class="wrap-productshot__boxbc-img p-relative">
                                                                ...
                                                                <a href="<?=$v["type"]?>/<?=$alias_l.$v["tenkhongdau"]?>" title="<?=$v["ten_$lang"]?>" rel="dofollow" class="d-block hover-left">
                                                                    ...
                                                                    <div class="wrap-productshot__boxbc-img-sale">
                                                                        ...
                                                                        <span class="wrap-productshot__boxbc-img-sale-content"><?=$func->percentPrice($v["giacu"],$v["giaban"])?></span>
                                                            ...
                                                            <div class="wrap-productshot__boxbc-content d-flex flex-column">
                                                                ...
                                                                <div class="wrap-productshot__boxbc-content-price d-flex flex-wrap mb10">
                                                                    ...
                                                                    <span class="wrap-productshot__boxbc-content-price-news col-6"><?=($v["giaban"]!=0) ? $func->changeMoney($v["giaban"],$lang).'/'.'m <sup>2</sup>':'Liên hệ';?></span>

                                                                    <del class="wrap-productshot__boxbc-content-price-old col-6"><?=($v["giacu"]!=0) ?  $func->changeMoney($v["giacu"],$lang).'/'.'m <sup>2</sup>':'';?></del>
                                                            ...
                                                            <div class="wrap-productshot__boxbc-bottom d-flex flex-wrap">
                                                                ...
                                                                <a href="javascript:void(0)" class="col-6 js-addcart-buynow" data-id="<?=$v["id"]?>" data-qty="1"><i class="fa-light fa-cart-shopping"></i> Mua ngay</a>

                                                                <span class="col-6">Lượt mua: <?=$v["luotxem"]?></span>
