<section class="carts pt10 pb20 bg-bray">
	...
	<div class="container">
		...
		<div class="row10 d-flex flex-wrap">
			...
			<div class="item10 col-12 w-100-m mb20 mt20">
				...
				<div class="wrap__paymentstep">
					...
					<div class="row10 d-flex flex-wrap">
						...
						<div class="item10 col-4 <?php if($com=='carts' && $_GET["src"]=='gio-hang'){echo "bg-step__active";}?> w-100-m w-100-t border-step-right">
			...
			<div class="item10 col-9 col-8-tablet w-100-m">
			...
			<div class="item10 col-3 col-4-tablet w-100-m">
