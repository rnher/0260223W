<div class="sideBar-product d-none d-block-m d-block-tablet">
    ...
    <div class="sideBar-product--title mb20">
        ...
        <span><span class="d-block ratio-img" img-width="60" img-height="51"><img class="ratio-img__content img-scale" src="./assets/images/loading_image.svg" data-src="<?=_upload_hinhanh_l.$mobile_logo["photo"]?>" alt="Logo công ty"></span> CUCHILAND</span>
