    ...
    <?php if(count($tintuc)>0){ ?>
        ...
        <div class="wrapper-featured__news mt30">
            ...
            <div class="sidebar__head">
                ...
                <span><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;Bài Viết Liên Quan</span>
            ...
            <ul class="wrapper-featured__news-list">
                ...
                <li class="wrapper-featured__news-item">
                    ...
                    rel="dofollow">
                        ...
                        <div class="wrapper-featured__news-info">
                            ...
                            <!-- <div class="wrapper-featured__news-info-date">
                                ...
                                <span><i class="fa-light fa-calendar-clock mr5"></i> <?=($value["ngaysua"]!=0) ? date('d/m/Y',$value["ngaysua"]) :date('d/m/Y',$value["ngaytao"]) ?> </span>

                            </div> -->

                            <div class="wrapper-featured__news-info-date">
                                                    <span><?= $seoDB["description_$lang"] ?></span>
                                                </div>
                        </div>
