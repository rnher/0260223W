            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                ...
                <tbody>
                    ...
                    <tr id="productct<?=$cartOrder[$i]['id']?>">
                        ...
                        <td align="center"><?= ($cartOrder[$i]['color_name'] != '') ?  $cartOrder[$i]['color_name']: 'Chưa chọn';?></td>
                        <td align="center"><?= ($cartOrder[$i]['size_name'] != '') ?  $cartOrder[$i]['size_name'] : 'Chưa chọn';?></td>
                        <td align="center">
                        ...
                        <td align="left" id="id_price<?=$cartOrder[$i]['id']?>">
