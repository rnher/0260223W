                ...
                buttons: {
                    ...
                    success: {
                        ...
                        action: function(){
                           ...
                           redirect("index.html?com=attribute&act=delete&type=<?=$_GET['type']?>&id_product=<?=$_GET['id_product']?>&page=<?=$_GET['page']?>&listid=" + listid);
            ...
            <div class="box-admin" style="display:flex; align-items:center;">
                ...
                <div class="box-action">
                    ...
                    <a class="btn btn-sm bg-gradient-primary text-white"
                        ...
                        href="index.html?com=attribute&act=add<?php if($_GET['id_product']!='') echo'&id_product='. $_GET['id_product'];?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="title_name_data">
                                    ...
                                    <div class="add-attr mt10">
                                        ...
                                        <?php if(!in_array($type,$viewArray)){
                                            $result=$db->rawQueryOne("select tenkhongdau_$lang as tenkhongdau,ten_vi from table_attribute_list where id='".$items[$i]['id_list']."' and type=?",array($type));
                                            $alias = "";
                                            if($result){
                                                $alias = $result['tenkhongdau'].'/';
                                            }
                                            ?>

                                        <a style="color:#37a000;font-size:12px"

                                            href="<?=$https_config.$items[$i]['type'].'/'.$alias.$items[$i]['tenkhongdau_'.$lang]?>" target="_blank"
                                        ...
                                        <a style="color:#37a000;font-size:12px"
                                            ...
                                            href="index.html?com=attribute&act=edit<?php if($_GET['id_list']!='') echo'&id_list='. $_GET['id_list'];?><?php if($_GET['id_cat']!='') echo'&id_cat='. $_GET['id_cat'];?><?php if($_GET['id_item']!='') echo'&id_item='. $_GET['id_item'];?><?php if($_GET['id_sub']!='') echo'&id_sub='. $_GET['id_sub'];?><?php if($_GET['id_product']!='') echo'&id_product='. $_GET['id_product'];?>&id=<?=$items[$i]['id']?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"
                                        ...
                                        <a style="color:#D33331;font-size:12px"
                                            ...
                                            href="index.html?com=attribute&act=delete&id=<?=$items[$i]['id']?><?php if($_GET['id_product']!='') echo'&id_product='. $_GET['id_product'];?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"
                                ...
                                <td class="actBtns">
                                    ...
                                    <a class="text-danger" data-id-product="<?=$_GET["id_product"]?>" data-product="<?=$items[$i]['id']?>" data-com="<?=$_GET['com']?>" data-act="delete" data-tbl="<?=$_GET['tbl']?>" data-type="<?=$_GET['type']?>" data-page="<?=$_GET['page']?>" href="javascript:" data-js-delete-attribute title=""
