...
<div class="wrapper">
    <div class="control_frm">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                <li><a
                        href="index.html?com=baiviet&act=add_cat&tbl=<?=$_GET['tbl']?><?php if($_GET['id_list']!='') echo'&id_list='. $_GET['id_list'];?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span><?=$GLOBAL_LEVEL2[$com][$type]['title']?></span></a>
                </li>
                <li class="current"><a href="#"
                        onclick="return false;"><?=($_GET['act']=='edit_cat') ? _sua : _them?></a></li>
            </ul>
            <div class="clear"></div>
        </div>
    </div>
    ...
    <form name="supplier" class="form form-validate"
        action="index.html?com=baiviet&act=save_cat&tbl=<?=$_GET['tbl']?><?php if($_REQUEST['id']!='') echo'&id='. $_REQUEST['id'];?><?php if($_GET['id_list']!='') echo'&id_list='. $_GET['id_list'];?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"
                                    ...
                                    <div class="box-alias"
                                        ...
                                        <div class="alias-text-disabled">
                                         ...
                                         <div style="position: relative;-ms-flex: 1 1 auto;flex: 1 1 auto;width: 1%;margin-bottom: 0;">
                                            <input type="text" name="data[tenkhongdau_<?=$k?>]" title="Nhập tên không dấu" id="alias_<?=$k?>"
                ...
                <div class="widget mtop0">
                    ...
                    <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                        ...
                        <div <?php if($GLOBAL_LEVEL2[$com][$type]['mota-ckeditor']==true) echo 'class="ck_editor"'; ?>>
                            <textarea title="Nhập mô tả . " data-height="400" id="mota_<?=$k?>"
                                <?php if($GLOBAL_LEVEL2[$com][$type]['mota-ckeditor']==true) echo 'class="ck_editors"'; ?>
                    ...
                    <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                        ...
                        <div <?php if($GLOBAL_LEVEL2[$com][$type]['noidung-ckeditor']==true) echo 'class="ck_editor"'; ?>>
                            <textarea title="Nhập mô tả . " data-height="400" id="noidung_<?=$k?>"
                                <?php if($GLOBAL_LEVEL2[$com][$type]['noidung-ckeditor']==true) echo 'class="ck_editors"'; ?>
                    ...
                    <div class="formRow">
                        <div class="formRight">
                            ...
                            <input type="text" class="tipS" value="<?=isset($item['stt'])?$item['stt']:$func->checkNumb('stt',$com.'_cat',$type)?>"
                ...
                <div class="box-admin" style="display:flex; align-items:center;justify-content:flex-end">
                    <div class="box-action">
                        ...
                        <a class="btn btn-sm bg-gradient-danger text-white"
                            href="index.html?com=baiviet&act=man_cat<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>">
