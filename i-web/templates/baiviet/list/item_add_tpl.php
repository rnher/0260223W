    ...
    <form name="supplier" class="form form-validate" action="index.html?com=baiviet&act=save_list&tbl=<?= $_REQUEST['tbl'] ?><?php if ($_REQUEST['id'] != '') echo '&id=' . $_REQUEST['id']; ?><?php if ($_REQUEST['type'] != '') echo '&type=' . $_REQUEST['type']; ?><?php if ($_REQUEST['page'] != '') echo '&page=' . $_REQUEST['page']; ?>" method="post" enctype="multipart/form-data" autocomplete="off" accept-charset="utf-8">
        ...
        <div class="mtop0">
            ...
            <div class="<?= ($GLOBAL_LEVEL1[$com][$type]['full'] == true) ? 'oneOne' : 'colLeft' ?>">
                ...
                <?php if ($GLOBAL[$com][$type]["link_direct"] == true) { ?>
                    ...
                    <div class="formRow lang_hidden active">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" name="data[link_direct]" title="Nhập 0 hoặc 1" id="link_direct" class="tipS" value="<?= @$item["link_direct"] ?>" />
            ...
            <div class="<?= ($GLOBAL_LEVEL1[$com][$type]['full'] == true) ? 'oneOne' : 'colRight' ?>">
                ...
                <div class="widget mtop0">
                    ...
                    <?php if ($GLOBAL_LEVEL1[$com][$type]['links'] == true) { ?>

                        <div class="formRow">

                            <label>Links danh mục</label>

                            <div class="formRight">

                                <input type="text" name="data[links]" title="Nhập links" id="links" class="tipS" value="<?= @$item['links'] ?>" />
                        ...
                        <?php if ($GLOBAL_LEVEL1[$com][$type]['mota_km'] == true) { ?>
                            ...
                            <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">
                                ...
                                <div class="ck_editor">
                                    ...
                                    <textarea title="Nhập mô tả [<?= $v ?>]. " data-height="400" id="mota_km_<?= $k ?>" <?= ($GLOBAL_LEVEL1[$com][$type]['mota_km-ckeditor'] == true) ? 'class="ck_editors"' : 'rows="8"' ?> name="data[mota_km_<?= $k ?>]"><?= @$item['mota_km_' . $k] ?></textarea>
                            ...
                            <?php foreach ($config['seo-lang'] as $k => $v) { ?>
                                ...
                                <div class="formRow">
                                    ...
                                    <div class="formRight">
                                        ...
                                        <textarea rows="8" cols="" title="Những đoạn code khách hàng muốn chèn trên header của website" class="tipS" name="dataseo[schema]"><?= @$seoDB['schema'] ?></textarea>
