            ...
            <div class="<?=($table['full']==true) ? 'oneOne':'colLeft' ?>">
                ...
                <div class="widget mtop0">
                    ...
                    <div class="formRow lang_hidden active">
                        ...
                        <label>Nút xem thêm 0(ẩn) 1(hiện)</label>

                        <div class="formRight">

                            <input type="text" name="data[link_direct]" title="Nhập 0 hoặc 1" id="link_direct"
...
<div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
    ...
    <label>Giới thiệu dịch vụ [<?=$v?>]</label>

    <div class="ck_editor">

        <textarea title="Nhập giới thiệu dịch vụ [<?=$v?>]. " data-height="400" id="intro_<?=$k?>"
                ...
                <div class="widget mtop0">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" data-validation="required"
                                data-validation-error-msg="Link không được để trống" name="data[link_facebook]"
                                title="Nhập link" id="link_facebook" class="tipS"
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" data-validation="required"
                                data-validation-error-msg="Link không được để trống" name="data[link_zalo]"
                                title="Nhập link" id="link_zalo" class="tipS" value="<?=@$item['link_zalo']?>" />
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" data-validation="required"
                                data-validation-error-msg="Link không được để trống" name="data[link_twitter]"
                                title="Nhập link" id="link_twitter" class="tipS" value="<?=@$item['link_twitter']?>" />
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" data-validation="required"
                                data-validation-error-msg="Link không được để trống" name="data[link_instagram]"
                                title="Nhập link" id="link_instagram" class="tipS"
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" name="data[slogan]"
                                title="Nhập mã sản phẩm" id="slogan" class="tipS" value="<?=@$item['slogan']?>" />
                    ...
                    <div class="formRow">
                        ...
                        <label>Link video / liên kết sản phẩm</label>
