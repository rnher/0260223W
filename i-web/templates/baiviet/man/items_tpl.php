                ...
                buttons: {
                    ...
                    success: {
                        ...
                        action: function(){
                           ...
                           redirect("index.html?com=baiviet&act=delete&type=<?=$_GET['type']?>&page=<?=$_GET['page']?>&listid=" + listid);
        ...
        <div class="bc">
            ...
            <ul id="breadcrumbs" class="breadcrumbs">
                ...
                <li><a
                        ...
                        href="index.html?com=baiviet&act=man<?php if($_GET['id_list']!='') echo'&id_list='. $_GET['id_list'];?><?php if($_GET['id_cat']!='') echo'&id_cat='. $_GET['id_cat'];?><?php if($_GET['id_item']!='') echo'&id_item='. $_GET['id_item'];?><?php if($_GET['id_sub']!='') echo'&id_sub='. $_GET['id_sub'];?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"><span><?=$GLOBAL[$com][$type]['title']?></span></a>
            ...
            <div class="box-admin d-flex d-block-m align-items-center">
                ...
                <div class="box-action">
                    ...
                    <a class="btn btn-sm bg-gradient-primary text-white"
                        ...
                        href="index.html?com=baiviet&act=add<?php if($_GET['id_list']!='') echo'&id_list='. $_GET['id_list'];?><?php if($_GET['id_cat']!='') echo'&id_cat='. $_GET['id_cat'];?><?php if($_GET['id_item']!='') echo'&id_item='. $_GET['id_item'];?><?php if($_GET['id_sub']!='') echo'&id_sub='. $_GET['id_sub'];?><?php if($_GET['id_product']!='') echo'&id_product='. $_GET['id_product'];?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center" class="title_name_data">
                                    ...
                                    <a href="index.html?com=baiviet&act=edit<?php if($_GET['id_list']!='') echo'&id_list='. $_GET['id_list'];?><?php if($_GET['id_cat']!='') echo'&id_cat='. $_GET['id_cat'];?><?php if($_GET['id_item']!='') echo'&id_item='. $_GET['id_item'];?><?php if($_GET['id_sub']!='') echo'&id_sub='. $_GET['id_sub'];?><?php if($_GET['id_product']!='') echo'&id_product='. $_GET['id_product'];?>&id=<?=$items[$i]['id']?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"
                                ...
                                <td class="title_name_data">
                                    ...
                                    <div class="add-attr mt10">
                                        ...
                                        <a style="color:#37a000;font-size:12px" title="Thuộc tính xem ngay"

                                            href="<?=$https_config.$items[$i]['type'].'/'.$items[$i]['tenkhongdau_'.$lang]?>" target="_blank"
                                        ...
                                        <a style="color:#37a000;font-size:12px ;margin: 0px 5px 5px;" title="Thuộc tính copy"

                                            href="index.html?com=baiviet&act=copy&id_copy=<?=$items[$i]['id']?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"
                                    ...
                                    <div class="attr-properties mt5">
                                        ...
                                        <?php /* if($GLOBAL[$com][$type]['color']==true){ ?>

                                            <a style="color:#37a000;font-size:12px;margin: 0px 5px 5px;" title="Thuộc tính màu"

                                                href="index.html?com=properties&act=man&id_product=<?=$items[$i]['id']?>&type=color<?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"

                                                class="tipS SC_bold">

                                                <i class="fa fa-cog"></i> Thêm màu
                                        ...
                                        <?php if($GLOBAL[$com][$type]['size']){?>
                                            ...
                                            href="index.html?com=attribute&act=man&type=size&id_product=<?=$items[$i]['id']?>&page=1"
                                                class="tipS SC_bold">
                                            ...
                                            <a style="color:#37a000;font-size:12px"
                                                href="index.html?com=attribute&act=man&type=color&id_product=<?=$items[$i]['id']?>&page=1"
                                                class="tipS SC_bold">
                                        ...
                                        <?php /* if($GLOBAL[$com][$type]['size']==true){ ?>
                                            ...
                                            <a style="color:#37a000;font-size:12px;margin: 0px 5px 5px;" title="Thuộc tính size"
                                ...
                                <?php if($GLOBAL[$com][$type]['cat']==true){?>
                                    <td align="center" class="title_name_data">
                                       ...
                                       <?php /*  <select select-w data-view-cat data-cat-<?=$items[$i]['id']?> data-product="<?=$items[$i]['id']?>" class="main_select select-w" name="select_cat" id="cat">
                                ...
                                <?php if($GLOBAL[$com][$type]['item']==true){?>
                                    <td align="center" class="title_name_data">
                                        ...
                                        ?>
                                           <?php /* <select select-w data-view-item data-item-<?=$items[$i]['id']?> data-product="<?=$items[$i]['id']?>" style="margin-top:10px" class="main_select select-w" name="select_item" id="item">
                                ...
                                <td align="center" align="center">
                                    ...
                                    <a data-push="<?=$items[$i]['id']?>"

                                        data-url="<?=$items[$i]['type']?>/<?=$items[$i]['tenkhongdau']?>"

                                        data-type="<?=$items[$i]['type']?>" data-val2="table_baiviet"

                                        rel="<?=$items[$i]['daytin']?>" data-val3="daytin"

                                        class="push-news diamondToggle <?=($items[$i]['daytin']==1)?"diamondToggleOff":""?>"
                            ...
                            <?php }?>
                                ...
                                <td align="center">
                                    ...
                                    <label class="stardust-checkbox checkOnOff">
                                        ...
                                        <input class="stardust-checkbox__input" data-id="<?=$items[$i]['id']?>"
                                            ...
                                            data-table="table_baiviet" data-type="<?=$key?>" rel="<?=$items[$i][$key]?>"
                                ...
                                <td class="actBtns">
                                    ...
                                    <a class="text-danger" data-product="<?=$items[$i]['id']?>" data-com="<?=$_GET['com']?>" data-act="delete" data-tbl="" data-type="<?=$_GET['type']?>" data-page="<?=$_GET['page']?>" href="javascript:" data-js-delete title=""
    ...
    $(document).ready(()=>{
        $('.select-w').on('change',function(){   
            ...
            if(action!='item'){
                ...
                data:{value:value,product:product,type:type,action:action},
