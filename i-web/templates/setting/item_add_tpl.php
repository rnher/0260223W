...
<form name="supplier" class="form" action="index.html?com=setting&act=save" method="post" enctype="multipart/form-data"
        ...
        <div class="widget mtop0">
            ...
            <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                ...
                <div class="formRight">
                    ...
                    <input 
                        type="text" name="data[address_<?=$k?>]" title="Nhập địa chỉ" id="address_<?=$k?>"
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input  type="text"
                        value="<?=@$item['email']?>" name="data[email]" title="Nhập địa chỉ email" class="tipS" />
            ...
            <div class="formRow ">
                ...
                <div class="formRight">
                    ...
                    <input  type="text"
                        name="data[chuky]" title="Nhập Chữ Ký" id="chuky" class="tipS"
                        value="<?=@$item['chuky']?>" />
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input 
                        type="text" value="<?=@$item['hotline']?>" name="data[hotline]" title="Nhập hotline"
                        class="tipS" />
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input 
                        type="text" value="<?=@$item['dienthoai']?>" name="data[dienthoai]" title="Nhập số điện thoại"
                        class="tipS" />
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input 
                        type="text" value="<?=@$item['website']?>" name="data[website]" title="Nhập địa chỉ website"
                        class="tipS" />
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input  type="text"
                        name="data[map_marker]" title="Những tọa bản đồ vào đây" class="tipS"
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <textarea  rows="8"
                        cols="" title="Những đoạn code nhúng bản đồ vào đây" class="tipS"
    ...
    <div class="colRight">
        ...
        <div class="widget mtop0">
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input 
                        type="text" name="data[page_in]" title="Nhập số item sản phẩm" id="page_in" class="tipS"
                        value="<?=@$item['page_in']?>" />
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input 
                        type="text" name="data[page_sp]" title="Nhập số item sản phẩm" id="page_sp" class="tipS"
                        value="<?=@$item['page_sp']?>" />
            ...
            <div class="formRow">
                ...
                <label>Số lượng sản phẩm trang chủ</label>

                <div class="formRight">

                    <input 
                        type="text" name="data[limit_sp]" title="Nhập số sản phẩm ở trang chủ" id="limit_sp" class="tipS"
                        value="<?=@$item['limit_sp']?>" />
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input 
                        type="text" name="data[page_ne]" title="Nhập số item sản phẩm" id="page_ne" class="tipS"
                        value="<?=@$item['page_ne']?>" />
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input 
                        type="text" name="data[page_video]" title="Nhập số item sản phẩm" id="page_video" class="tipS"
            ...
            <div class="formRow">
                ...
                <label>Phân trang thư viện ảnh:</label>

                <div class="formRight">

                    <input 
                        type="text" name="data[page_album]" title="Nhập số item sản phẩm" id="page_album" class="tipS"
            ...
            <div class="formRow">
                ...
                <label>Phân trang dịch vụ:</label>

                <div class="formRight">

                    <input 
                        type="text" name="data[page_service]" title="Nhập số item sản phẩm" id="page_service" class="tipS"
        ...
        <div class="formRow">
            <label>Hình đóng dấu : <span style="color:#f00">(max-width:216px-max-height:216px)</span></label>
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input readonly="readonly" type="text" style="width:45px; margin-top:10px; text-align:center;"
                        name="des_char" id="des_char" value="<?=@$item['des_char']?>" /> <?=_kytu?> <b>(Từ 160-300 ký
                        tự)</b>
