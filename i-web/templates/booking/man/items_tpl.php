                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <?php if ($GLOBAL[$com][$type]['email'] == true) { ?>
                                ...
                                <td width="10%" class="tb_data_small" style="text-align: left !important;">Email</td>
                            ...
                            <?php if ($GLOBAL[$com][$type]['dichvu'] == true) { ?>
                                ...
                                <td width="20%" style="text-align: left !important;">Dịch vụ</td>
                        ...
                        <?php for ($i = 0, $count = count($items); $i < $count; $i++) { ?>
                            ...
                            <tr>
                                ...
                                <?php if ($GLOBAL[$com][$type]['dichvu'] == true) {
                                    ...
                                    $getService = $db->rawQueryOne("select id,ten_$lang as ten,tenkhongdau_$lang as tenkhongdau,photo from #_baiviet where hienthi=1 and type=? and id=? limit 1", array('dich-vu', $items[$i]["id_dichvu"]));
