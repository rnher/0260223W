...
<div class="wrapper">
    ...
    <div class="control_frm">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                <li><a href="index.html?com=video&act=add<?php if ($_REQUEST['type'] != '') echo '&type=' . $_REQUEST['type']; ?>"><span><?= ($_GET['act'] == 'edit') ? _sua : _them ?>
    ...
    <form name="supplier" id="validate" class="form" action="index.html?com=video&act=save<?php if ($_REQUEST['id'] != '') echo '&id=' . $_REQUEST['id']; ?><?php if ($_REQUEST['type'] != '') echo '&type=' . $_REQUEST['type']; ?>" method="post" enctype="multipart/form-data">
        <div class="mtop0">
                    ...
                    <?php foreach ($config['lang'] as $k => $v) { ?>
                        ...
                        <?php if ($GLOBAL['video']['video']['mota'] == true) { ?>
                            <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">
                                <label><?= _mota ?> [<?= $v ?>]</label>
                                <div class="ck_editor">
                                    <textarea title="Nhập mô tả . " data-height="400" id="mota_<?= $k ?>" <?= ($GLOBAL['video']['video']['mota-ckeditor'] == true) ? 'class="ck_editors"' : 'rows="8"' ?> name="data[mota_<?= $k ?>]"><?= @$item['mota_' . $k] ?></textarea>
                                </div>
                                <div class="clear"></div>
                            </div>
                        <?php } ?>
            ...
            <div class="<?= ($config_cap1['full'] == true) ? 'oneOne' : 'colRight' ?>">
                <div class="widget mtop0">
                    ...
                    <?php if ($GLOBAL['video']['video']['list'] == true) { ?>
                    ...
                    <?php if ($GLOBAL['video']['video']['upload'] == true) { ?>
                        <div class="formRow ">
                            <label><?= _uploadvideo ?>:</label>
                            <div class="formRight">
                                <input type="file" id="video" name="video" />
                                <img src="./images/question-button.png" alt="Upload hình" class="icon_question tipS" original-title="Tải hình ảnh (ảnh mp4)">
                                <span style="display: inline-block; line-height: 30px;color:#CCC;">
                                    mp4|MP4
                                </span>
                            </div>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <video width="300" height="200" autoplay muted controls>
                                    <source src="<?= _upload_video . @$item['video'] ?>" type="video/mp4">
                                </video>
                            </div>
                            <div class="clear"></div>
                        </div>
                    ...
                    <?php if ($GLOBAL['video']['video']['link'] == true) { ?>
                            ...
                            <div class="formRow">
                                ...
                                <div class="formRight">
                                    ...
                                    <object width="300" height="200">
                                        <param name="movie" value="//www.youtube.com/v/<?= $func->getYoutube($item['links']) ?>?version=3&amp;hl=vi_VN&amp;rel=0">
                                        </param>
                                        <param name="allowFullScreen" value="true">
                                        </param>
                                        <param name="allowscriptaccess" value="always">
                                        </param><embed src="//www.youtube.com/v/<?= $func->getYoutube($item['links']) ?>?version=3&amp;hl=vi_VN&amp;rel=0" type="application/x-shockwave-flash" width="300" height="200" allowscriptaccess="always" allowfullscreen="true" wmode="transparent"></embed>
                                    </object>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <input type="text" name="data[links]" title="Nhập tên links youtobe" id="ten_en" class="tipS validate[required]" value="<?= @$item['links'] ?>" />
                            </div>
                            <div class="clear"></div>
                        </div>
                    <?php } ?>
                    ...
                    <?php if ($GLOBAL['video']['video']['seo'] == true) { ?>
                        <div class="widget mtop10">
                            ...
                            <div class="formRow">
                                <label><?= _title1 ?></label>
                                <div class="formRight">
                                    <input type="text" value="<?= @$item['title'] ?>" name="data[title]" title="Nội dung thẻ meta Title dùng để SEO" class="tipS" />
                                </div>
                                <div class="clear"></div>
                            </div>
                            ...
                            <div class="formRow">
                                ...
                                <div class="formRight">
                                    <input type="text" value="<?= @$item['keywords'] ?>" name="data[keywords]" title="Từ khóa chính cho danh mục" class="tipS" />
                                </div>
                                <div class="clear"></div>
                            </div>
                            ...
                            <div class="formRow">
                                ...
                                <div class="formRight">
                                    <textarea rows="4" cols="" title="Nội dung thẻ meta Description dùng để SEO" class="tipS" name="data[description]" id="description"><?= @$item['description'] ?></textarea>
                                    <input readonly="readonly" type="text" style="width:45px; margin-top:10px; text-align:center;" name="des_char" id="des_char" value="<?= @$item['des_char'] ?>" /> ký tự <b>(Tốt nhất là 68 - 170 ký
                                        tự)</b>
                                </div>
                                <div class="clear"></div>
                            </div>
        ...
        <div class="formRow fixedBottom sidebar-bunker">
            <div class="formRight">
                ...
                <a href="index.html?com=video&act=man<?php if ($_REQUEST['id'] != '') echo '&id=' . $_REQUEST['id']; ?><?php if ($_REQUEST['type'] != '') echo '&type=' . $_REQUEST['type']; ?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS redB" original-title="Thoát"><?= _thoat ?></a>
            </div>
            <div class="clear"></div>
        </div>
    </form>
