            ...
            <div class="widget mtop0">
                <?php foreach ($config['lang'] as $k => $v) { ?>
                    ...
                    <?php if ($GLOBAL[$com][$type]['img'] == true) { ?>
                        ...
                        <div class="formRow lang_hidden lang_<?= $k ?>  <?= ($k == 'vi') ? 'active' : '' ?>">
                            ...
                            <div class="formRight">
                                <div class="mt10"><img src="<?= _upload_hinhanh . $item['photo_' . $k] ?>" alt="NO PHOTO" width="100" /></div>
                            </div>
                            <div class="clear"></div>
                        </div>
                    <?php } ?>
                ...
                <?php if ($GLOBAL[$com][$type]['linhvuc'] == true) { ?>
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <input type="text" id="code_pro" name="data[linh_vuc]" value="<?= $item["linh_vuc"] ?>" title="Nhập link liên kết cho hình ảnh" class="tipS" />
                        </div>
                        <div class="clear"></div>
                    </div>
                <?php } ?>
                <?php if ($GLOBAL[$com][$type]['nam'] == true) { ?>
                    <div class="formRow">
                        <label>Năm:</label>
                        <div class="formRight">
                            <input type="text" id="code_pro" name="data[nam]" value="<?= $item["nam"] ?>" title="Nhập link liên kết cho hình ảnh" class="tipS" />
                        </div>
                        <div class="clear"></div>
                    </div>
                <?php } ?>
                <?php if ($GLOBAL[$com][$type]['phone'] == true) { ?>
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <input data-validation="required" data-validation-error-msg="điện thoại không được để trống" type="text" id="code_pro" name="data[phone]" value="" title="Nhập số điện thoại" class="tipS" />
                        </div>
                        <div class="clear"></div>
                    </div>
                <?php } ?>
                <?php if ($GLOBAL[$com][$type]['link'] == true) { ?>
                    <div class="formRow">
                        <label>Nút liên hệ 0(ẩn) 1(hiện): </label>
                        <div class="formRight">
                            <input type="text" id="price" name="data[link]" value="<?= @$item['link'] ?>" title="Nhập 0 hoặc 1" class="tipS" />
                        </div>
                        <div class="clear"></div>
                    </div>
                <?php } ?>
