    ...
    <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
      ...
      <thead>
        ...
        <tr>
          ...
          <td class="tb_data_small" style="width: 110px!important;"><div>Tỉnh/thành phố<span></span></div></td>
          <td class="tb_data_small" style="width: 110px!important;"><div>Quận/huyện<span></span></div></td>
...
<a href="javascript:" class="tipS SC_bold">  <?php foreach ($city_place as $key => $value) {
                                            if ($items[$i]['id_city'] == $value["id"]) {
...
<a href="javascript:" class="tipS SC_bold">  <?php foreach ($dataDist as $key => $value) {
                                            if ($items[$i]['id_dist'] == $value["id"]) {
