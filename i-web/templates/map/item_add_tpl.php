                    ...
                    <?php foreach ($config['lang'] as $k => $v) { ?>
                        ...
                        <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">
                            ...
                            <div class="formRight">
                                ...
                                <input type="text" data-validation="required" data-validation-error-msg="Tên không được để trống" name="data[ten_<?= $k ?>]" title="Nhập tên danh mục" id="ten_<?= $k ?>" class="tipS validate[required]" value="<?= @$item['ten_' . $k] ?>" />
                        ...
                        <?php if ($GLOBAL[$com][$type]['diachi']) { ?>
                            <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">
                                ...
                                <div class="ck_editor">
                                    ...
                                    <textarea data-validation="required" data-validation-error-msg="Địa chỉ không được để trống" title="Nhập địa chỉ [<?= $v ?>]. " id="diachi_<?= $k ?>" rows="3" name="data[diachi_<?= $k ?>]"><?= @$item['diachi_' . $k] ?></textarea>
                        ...
                        <?php if ($GLOBAL[$com][$type]['mota']) { ?>
                            <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">
                                ...
                                <div class="ck_editor">
                                    ...
                                    <textarea title="Nhập mô tả [<?= $v ?>]. " data-height="400" id="mota_<?= $k ?>" rows="3" <?= ($table['mota-ckeditor'] == true) ? 'class="ck_editors"' : 'rows="8"' ?> name="data[mota_<?= $k ?>]"><?= @$item['mota_' . $k] ?></textarea>
                        ...
                        <?php if ($GLOBAL[$com][$type]['noidung']) { ?>
                            <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">
                                ...
                                <div class="ck_editor">
                                    ...
                                    <textarea title="Nhập nội dung [<?= $v ?>]. " data-height="400" id="noidung_<?= $k ?>" rows="8" <?= ($table['noidung-ckeditor'] == true) ? 'class="ck_editors"' : 'rows="8"' ?> name="data[noidung_<?= $k ?>]"><?= @$item['noidung_' . $k] ?></textarea>
                ...
                <div class="widget mtop0">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" data-validation="required" data-validation-error-msg="Điện thoại không được để trống" name="data[phone]" title="Nhập phone" id="phone" class="tipS" value="<?= @$item['phone'] ?>" />
                    ...
                    <?php if ($GLOBAL[$com][$type]['email']) { ?>
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <input data-validation="required" data-validation-error-msg="Email không được để trống" type="text" name="data[email]" title="Nhập email" id="email" class="tipS" value="<?= @$item['email'] ?>" />
                    ...
                    <?php if ($GLOBAL[$com][$type]['toado']) { ?>
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <input type="text" data-validation="required" data-validation-error-msg="Tọa độ không được để trống" name="data[toado]" title="Nhập tọa độ" id="toado" class="tipS" value="<?= @$item['toado'] ?>" />
                    ...
                    <?php if ($table['website']) { ?>
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <input type="text" data-validation="required" data-validation-error-msg="website không được để trống" name="data[website]" title="Nhập web" id="website" class="tipS" value="<?= @$item['website'] ?>" />
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" class="tipS" value="<?= isset($item['stt']) ? $item['stt'] : $func->checkNumb('stt', $com, '') ?>" name="stt" style="width:40px; text-align:center;" onkeypress="return OnlyNumber(event)" original-title="Số thứ tự của danh mục, chỉ nhập số">
