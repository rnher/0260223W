...
<meta name="robots" content="<?php if($source=='index' || $source=='baiviet' ){echo $config['website']['robots']; }else{ if($row_detail["index_robots"] !=''){ echo $row_detail["index_robots"]; }else{ echo $config['website']['robots'];}}?>" />
