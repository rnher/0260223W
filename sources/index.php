<?php  if(!defined('_source')) die("Error");
    ...
    $about=$db->rawQueryOne("select ten_$lang as ten, mota_$lang as mota,photo,job_$lang  as job,nguoidaidien_$lang as nguoidaidien from #_info where type=? limit 0,1",array('gioi-thieu'));
